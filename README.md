...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <td style="width: 50%; padding: 10px;">
      <h3 style="margin: 0;">The Use of C# in Unity</h3>
    </td>
    <td style="width: 50%; padding: 10px; text-align: right;">
      <a href="https://web.dio.me/articles/a-utilizacao-de-c-na-unity?back=%2Farticles&page=1&order=oldest" target="_blank">
        <button style="background-color:#4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; width: 100%;">Read Article</button>
      </a>
    </td>
  </tr>
</table>
